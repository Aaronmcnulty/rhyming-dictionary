...
function addToSavedWordsList(rhymeString) {
  ...
  let parsedSavedWordArray = JSON.parse(
    sessionStorage.getItem("savedWordArray")
  );
  //If the array does not include the 'rhymeString', push passed in argument to the 'parsedSavedWordArray'.
  ...
  sessionStorage.setItem(
    "savedWordArray",
    JSON.stringify(parsedSavedWordArray)
  );
}
